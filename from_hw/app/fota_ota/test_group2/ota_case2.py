...
class OtaTg2Case2(AwProvider):
    def __init__(self, app=None):
        super(OtaTg2Case2, self).__init__()
        self.description = "tg2/测试用例2"
        self.app = app
        self.route_path = "fota_ota/tg2/ota_case2"
    ...
    def reset(self, params):
        ...
        self.reportContent = {
            ...
            "labels": [{"name": "suite", "value": "fota_ota/tg2"}],
            "steps": []
        }
